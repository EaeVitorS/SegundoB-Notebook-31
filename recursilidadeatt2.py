...
label = Label(root, text='você prefere qual?', font='Arial 20 bold', bg='white')
label.pack()  # O método pack() deve ser chamado em uma linha separada
ButtonYes = Button(root, text='Mulher', font='Arial 20 bold')
ButtonYes.place(x=170, y=100)
ButtonYes.bind('<Enter>', motionMouse)
ButtonNo = Button(root, text='Homem', font='Arial 20 bold', command=no)
